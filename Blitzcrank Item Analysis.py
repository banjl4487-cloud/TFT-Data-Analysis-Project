...
blitz_item_data = {
    ...
    '아이템 이름': [
        'Warmog\'s Armor',            # 77번, 방어아이템 (체력)
        'Redemption',                 # 47번, 방어아이템 (체력, 힐)
        'Frozen Heart',               # 45번, 방어아이템 (방어력, 마나, 공속 감소)
        'Bramble Vest',               # 55번, 방어아이템 (방어력, 치명타 방어)
        'Dragon\'s Claw',             # 66번, 방어아이템 (마법 저항력)
        'Locket of the Iron Solari',  # 35번, 방어아이템 (쉴드 유틸)
        'Chain Vest',                 # 5번, 방어아이템 (방어력)
        'Shroud of Stillness',        # 59번, 방어아이템 (마나 봉쇄 유틸)
        'Zephyr',                     # 67번, 비 방어아이템 (상대 챔프 띄우기 유틸)
        'Zeke\'s Herald'              # 17번, 비 방어아이템 (공격 속도 버프 유틸)
    ],
    '장착 횟수': [5200, 4800, 4100, 3500, 3200, 2800, 2500, 2000, 1500, 1200], # 가상 장착 횟수
    '방어 아이템 여부': [
        '방어아이템', '방어아이템', '방어아이템', '방어아이템', '방어아이템',
        '방어아이템', '방어아이템', '방어아이템', '비 방어아이템', '비 방어아이템'
    ]
}
...
blitz_defense_count = sum(df_blitz_items['방어 아이템 여부'] == '방어아이템')
...
blitz_summary_rows = pd.DataFrame([
    ...
    {
        '순위': np.nan,
        '아이템 이름': f"  - 비 방어 아이템 비율: {blitz_non_defense_ratio:.2f}%",
