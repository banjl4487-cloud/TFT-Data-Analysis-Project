...
# --------------------------------------------------------------------------
# --- 0단계: TFT_Item_CurrentVersion.csv' 파일 로드 ---
...
# --------------------------------------------------------------------------
# --- '필사적인 1단계: 아이템 타입 ('item_type') 분류를 위한 기본 아이템 리스트 정의 ---
# '강력하게 "기본 아이템(Component Items)"' 이름들을 여기에 '입력해야 됨'
...
# ' classify_item 함수'를 사용해서 'item_type' 컬럼 생성
...
# --------------------------------------------------------------------------
# --- ' 2단계: 방어 아이템 ('is_defensive') 분류를 위한 방템 리스트 정의 ---
# 이 부분도 '수동 정의'가 필요하며, 'TFT 공식 명칭'과 '초 필사적인 대소문자, 띄어쓰기'가 정확히 일치해야 함
defensive_items = [
    "Guardian Angel",          # 수호천사
...
# --------------------------------------------------------------------------
# --- '3단계: 통합 분류 완료된 df_item을 새로운 CSV 파일로 저장 ---
